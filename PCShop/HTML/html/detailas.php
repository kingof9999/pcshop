...
if(isset($_POST["btn_comment"])){
    ...
    $query 	= "SELECT * FROM product_assosi WHERE id_product_as='$asid'";
	...
	<div class="container">
		<div class="breadcrumb-inner">
			<ul class="list-inline list-unstyled">
				...
				<li class='active'><?php echo $row["name_product_as"]?></li>
			</ul>
        ...
        <div class="single-product-gallery-thumbs gallery-thumbs">
					...
					<div class='col-sm-6 col-md-7 product-info-block'>
						<div class="product-info">
							<h1 class="name"><?php echo $row["name_product_as"]?></h1>
							...
							<div class="quantity-container info-container">
								<div class="row">
									...
									<div class="col-sm-7">
										<a href="index.php?url=add_cart&masp=<?php echo $row["id_product_as"]?>" class="btn btn-primary"><i class="fa fa-shopping-cart inner-right-vs"></i> ADD TO CART</a>
									</div>
										...
										<div class="product-add-review">
											...
											<div class="review-form">
												<div class="form-container">
													<form role="form" class="cnt-form" action="<?php echo'index.php?url=detail&asid='.$asid.''?>" method="post">
														<div class="row">
															<div class="col-sm-6">
