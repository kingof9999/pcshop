<?php
    ...
    if(isset($_POST["submit"])){
        ...
        if($check){
			$query="UPDATE accessories SET name_as='$name_as',quantity='$quantity',price='$price',decription='$description',day='$day' 
                    WHERE id_as='$userid'";
			$result = mysqli_query($con,$query)or die("Error: ".mysqli_error($con));
			if($result){
				$msg = "Success";
                header ('Location: ../accessories_manager.php');
			}
		}
    }
?>
                                ...
                                <div class="form quick-post">
                                    ...
                                    <form class="form-horizontal">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-10">
                                                <input type="text" placeholder="Enter Name Product" name="name_as" class="form-control" id="name_as" value="<?php echo $row["name_as"]?>"/>
                                            </div>
                                        </div>
                                        <!-- Quantity -->
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-10">
                                                <input type="number" placeholder="Enter Quantity" name="quantity" class="form-control" id="quantity" value="<?php echo $row["quantity"]?>"/>
                                            </div>
                                        </div>
                                        <!-- Price -->
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-10">
                                                <input type="number" placeholder="Enter Price" name="price" class="form-control" id="price" value="<?php echo $row["price"]?>"/>
                                            </div>
                                        </div>
                                        <!-- Decription -->
                                        <div class="form-group">
