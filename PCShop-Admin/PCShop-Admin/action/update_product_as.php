<?php
    ...
    if(isset($_POST["submit"])){
        ...
        if($check){
			$query="UPDATE product_assosi SET name_product_as='$name_product_as',quantity='$quantity',price='$price',id_as='$id_as',description='$description',day='$day',image='$file_name' 
        ...
        <div id="sidebar" class="nav-collapse ">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a class="" href="../html/productaccess_manager.php">Manager</a></li>
