<?php
    ...
    if(isset($_POST["submit"])){
		...
		$check = true;
       if($id_ca1 == $id_ca){
			$id_ca1_error = "The ID allredy had<br>";
			$check = false;
		}
        if($check){
			$query="INSERT INTO customer_account(id_ca,user_name,email,password,status)
				VALUES('$id_ca1','$user_name','$email','$password','$status')";
			$result = mysqli_query($con,$query)or die("Error: ".mysqli_error($con));

			if($result){
				header('Location: input_customer1.php?id='.$id_ca1.'');
			}
		}
                        ...
                        <div class="panel-body">
                            ...
                            <form name="form-admin-newproduct" action="<?php echo $_SERVER["PHP_SELF"] ?>" method="post">
                                <div class="form quick-post">
                                    ...
                                    <form class="form-horizontal">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-10">
                                                <input type="text" placeholder="Enter ID" name="id_ca1" class="form-control" id="id_ca1"/>
                                            </div>
                                        </div>
                                        <!-- User Name -->
                                        <div class="form-group">
                                ...
                                <span>
    								<h5>
    									<?php 
    										if(isset($id_ca1_error)) echo $id_ca1_error;
