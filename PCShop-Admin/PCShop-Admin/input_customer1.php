<?php
    ...
    $userid = $_GET["id"];
    $query = "SELECT * FROM customer_account WHERE id_ca='$userid'";
    ...
    if(isset($_POST["submit"])){
       ...
       /* if(strlen($name_product) == 0){
        ...
        if($check){
			$query="INSERT INTO customer(id_customer,id_ca,cus_type,phone,address,cus_name)
				VALUES('$userid','$userid','$cus_type','$phone','$address','$cus_name')";
                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="padd">
                            <form name="form-admin-newproduct" action="input_customer1.php?id=<?php echo $userid?>" method="post">
                                <div class="form quick-post">
                                    ...
                                    <form class="form-horizontal">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-10">
                                                <input type="text" placeholder="Enter Customer Phone" name="phone" class="form-control" id="phone"/>
                                            </div>
                                        </div>
                                        <!-- Address -->
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-10">
                                                <input type="text" placeholder="Enter Customer Name" name="cus_name" class="form-control" id="cus_name"/>
                                            </div>
                                        </div>
