<?php
    ...
    if(isset($_POST["submit"])){
        ...
        if($check){
			$query="INSERT INTO catalog(name_catalog,parent_id)
				VALUES('$name_catalog','$parent_id')";
                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="padd">
                            <form name="form-admin-newproduct" action="<?php echo $_SERVER["PHP_SELF"] ?>" method="post">
                                <div class="form quick-post">
                                    ...
                                    <form class="form-horizontal">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-10">
                                                <input type="text" placeholder="Enter Name Catalog" name="name_catalog" class="form-control" id="name_catalog"/>
                                            </div>
                                        </div>
                                        <!-- Parent ID -->
                                        <div class="form-group">
                                            <label class="control-label col-lg-2" for="content">ID Parent</label>
                                            <div class="col-lg-10">
                                                <input type="text" placeholder="Enter ID Parent" name="parent_id" class="form-control" id="parent_id"/>
                                            </div>
                                        </div>
