                                ...
                                <div class="form quick-post">
                                    ...
                                    <form class="form-horizontal">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-10">
                                                <input type="text" placeholder="Enter Name Manufacturer" name="name_mf" class="form-control" id="name_mf"/>
                                            </div>
                                        </div>
                                        <!-- Decription -->
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-10">
                                                <textarea name="decription" value="" rows="10" cols="100" class="input-medium" id="decription"></textarea>
                                            </div>
                                        </div>
