...
<section id="container" class="">
    ...
    <section id="main-content">
        <section class="wrapper">
            <form name="form-admin-product" action="customer_manager.php" method="post">
            <div class="row">
                               ...
                               if(isset($_POST["btn_search"])){
                                    ...
                                    if($trangthai == 1){  
                                        $query = "SELECT c.id_customer,c.id_ca,c.cus_type,c.phone,c.address,c.cus_name,ca.email,ca.user_name,ca.status,ca.password 
                                                    FROM customer c,customer_account ca WHERE ca.id_ca=c.id_customer AND c.cus_name LIKE '%$text%'";
                                    ...
                                    ';
                                        ...
                                        $query = "SELECT c.id_customer,c.id_ca,c.cus_type,c.phone,c.address,c.cus_name,ca.email,ca.user_name,ca.status,ca.password 
                                                    FROM customer c,customer_account ca WHERE ca.id_ca=c.id_customer AND ca.email LIKE '%$text%'";
                                        $result = mysqli_query($con,$query)or die("LOI LIET KE: ".mysqli_error($con));
                                        $num 	= mysqli_num_rows($result);
                                        echo'
                                        <table class="table table-striped table-advance table-hover">
                                    ...
                                    ';
                                        ...
                                        $query = "SELECT c.id_customer,c.id_ca,c.cus_type,c.phone,c.address,c.cus_name,ca.email,ca.user_name,ca.status,ca.password 
                                                    FROM customer c,customer_account ca WHERE ca.id_ca=c.id_customer AND c.phone LIKE '%$text%'";
                                        $result = mysqli_query($con,$query)or die("LOI LIET KE: ".mysqli_error($con));
                                        $num 	= mysqli_num_rows($result);
                                        echo'
                                        <table class="table table-striped table-advance table-hover">
