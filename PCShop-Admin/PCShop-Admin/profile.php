                    ...
                    <div class="profile-widget profile-widget-info">
                        <div class="panel-body">
                            ...
                            <div class="col-lg-4 col-sm-4 follow-info">
                                <p>Hello I’m Thuan, a admin PC Shop .</p>
                                <p>@thuanluu</p>
                                <p><i class="fa fa-twitter">FireFox</i></p>
                                <h6>
                                    <span><i class="icon_clock_alt"></i>11:05 AM</span>
                                    <span><i class="icon_calendar"></i>25.10.13</span>
                                    <span><i class="icon_pin_alt"></i>DN</span>
                                </h6>
                            </div>
                                ...
                                <div id="profile" class="tab-pane">
                                    <section class="panel">
                                        <div class="bio-graph-heading">
                                            Hello I’m Thuan,a admin of PC Shop Admin and i'm designer.
                                        </div>
                                        <div class="panel-body bio-graph-info">
                                            <h1>Bio Graph</h1>
                                            <div class="row">
                                                <div class="bio-row">
                                                    <p><span>First Name </span>: Thuan </p>
                                                </div>
                                                <div class="bio-row">
                                                    <p><span>Last Name </span>: Luu</p>
                                                </div>
                                                <div class="bio-row">
                                                    <p><span>Birthday</span>: 20 May 1995</p>
                                                </div>
                                                <div class="bio-row">
                                                    <p><span>Country </span>: Viet Nam</p>
                                                </div>
                                                <div class="bio-row">
                                                    <p><span>Occupation </span>: Front-end Developer</p>
                                                </div>
                                                <div class="bio-row">
                                                    <p><span>Email </span>:thuanprovp1@gmail.com</p>
                                                </div>
                                                <div class="bio-row">
                                                    <p><span>Mobile </span>: (+84) 0905 010 830</p>
                                                </div>
                                                <div class="bio-row">
                                                    <p><span>Phone </span>: (+84) 0905 010 830</p>
                                                </div>
                                            </div>
                                        </div>
                                    </section>
