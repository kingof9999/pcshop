<?php
    ...
    if(isset($_POST["submit"])){
        ...
        if($check){
			$query="INSERT INTO accessories(name_as,quantity,price,day,decription)
                     VALUES('$name_as','$quantity','$price','$day','$description')";
                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="padd">
                            <form name="form-admin-newas" action="<?php echo $_SERVER["PHP_SELF"] ?>" method="post" >
                                <div class="form quick-post">
                                    ...
                                    <form class="form-horizontal">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-10">
                                                <input type="text" placeholder="Enter Name Product" name="name_as" class="form-control" id="name_as"/>
                                            </div>
                                        </div>
                                        <!-- Quantity -->
                                        <div class="form-group">
